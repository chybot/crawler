...
class QinghaiNbHandler(ParserNbBase):
    """
    QinghaiNbHandler is used to parse the annual report
    @version:1.0
    @author:John Liu
    @modify:
    """
    def __init__(self, pinyin):
        ...
        self.log.info(u"QinghaiNbHandler 构造完成")
    ...
    def parse(self, html_dict, reslt_dict=None):
        ...
        self.log.info(u"QinghaiNbHandler解析结果：\n" + result_json)
        return reslt_dict
